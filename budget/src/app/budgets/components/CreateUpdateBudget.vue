				...
				<form class="form" @submit.prevent="processSave">
					...
					<div class="field is-grouped">
						<div class="control">
							...
							<button class="button is-primary" v-if="!this.editing">Submit</button>
							<button class="button is-primary" v-else>Update</button>
						</div>
						<div class="control">
	...
	export default {
		...
		methods: {
			...
			processDuplicateBudget(budgetId) {
				if (
					confirm(
						"Are you sure you want to duplicate that budget? Doing this will overwrite all existing data for this month (transaction data will NOT be erased)."
					)
				) {
